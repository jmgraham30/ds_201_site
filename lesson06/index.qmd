...
$$
p(x) = \frac{n!}{(n-1)! k!}\pi^{x}(1 - \pi)^{n -x}
$$
...
There are some important properties that are hepful to know about expected value and variance. Namely, 
...
Let's work through some examples together in an RStudio project. 
