...
### `r icons::icon_style(icons::fontawesome("r-project"),scale=2,fill="steelblue")` `tidymodels`
...
## `r icons::icon_style(icons::fontawesome("r-project"),scale=2,fill="steelblue")` `tidymodels` Machine Learning Workflow
