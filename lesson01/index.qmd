...
There is a website for the course, link [here](https://intro-ds.netlify.app/). For course logistics, see the official course syllabus available [here](https://intro-ds.netlify.app/syllabus.html). Assignments and other information specific to the course in a given semester will be posted on the course learning management system (LMS). The course website provides links to many additional resources, see link [here](https://intro-ds.netlify.app/links.html).
...
Let's begin our adventure in data science by engaging with some of the interactive tools on the [Gapminder](https://www.gapminder.org/) website. The link to Gapminder is available [here](https://www.gapminder.org/). The Gapminder organization is a non-profit entity that seeks to use data to educate people about large-scale social issues. Gapminder has a particular focus on addressing certain types of common misconceptions about the world. 



Follow [this link](https://www.gapminder.org/tools/#$chart-type=bubbles&url=v1) to the interactive data tools by Gapminder.
...
**Question** What is the relationship between income and life expectancy based on the . How do income and life expectancy each  change over time? Does the relationship between income and life expectancy change over time? 
...
A small portion of the data available form Gapminder is shown in @tbl-gp below: [^2]
...
A data set that satisfies properties 1 - 3 is said to by **tidy** or in tidy format. We will often find it very useful to work with data that conforms to the tidy format. 
...
1. Numerical (quantitative):
    ...
    * Continuous:  Can take on any value and any value between two values. Typically will involve decimal values. Physical measurements are common types of continuous numerical data. 
