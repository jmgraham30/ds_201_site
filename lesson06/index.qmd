...
* $A = $ the event that the first toss is heads, and 

* $B = $ the event that at least one toss is heads. 

Then,

* $P(A|B) = $ the probability that the first toss is heads given that at least one toss is heads, and 

* $P(B|A) = $ the probability that at least one toss is heads given  that at the first toss is heads. 
