...
**Exercise:** Redo what we have done in boootstraping the mean of a sample from a normal random variable but instead boostrap the median. You can use the fact that teh function `median` computes the sample median. How do the results compare and contrast with those of the mean?
